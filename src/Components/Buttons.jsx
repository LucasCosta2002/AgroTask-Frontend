...
const Buttons = ({trabajo}) => {
    ...
    const {handleModalEditarTrabajo, handleModalEliminarTrabajo} = useTrabajos();
        ...
        <>
            <div className="flex gap-2">
                ...
                <div className="group relative flex flex-col items-center justify-center">
                    <button onClick={() => handleModalEditarTrabajo(trabajo)} className="bg-indigo-500 p-2 rounded-md text-white  hover:bg-indigo-600 transition-all" >
                ...
                <div className="group relative flex flex-col items-center justify-center">
                    <button onClick={() => handleModalEliminarTrabajo(trabajo)} className="bg-red-600 p-2 rounded-md text-white hover:bg-red-700 transition-all " >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
