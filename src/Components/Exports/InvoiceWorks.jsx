...
const InvoiceWorks = ({works}) => {
        ...
        <View style={styles.titleContainer}>
            <View style={styles.spaceBetween}>
                <View>
                    ...
                    <Text style={styles.invoiceNumber}>Identificador de Trabajo: {} </Text>
                </View>
                <View>
    ...
    const TableBody = ( works ) => (
       works?.map( work => (
            <Fragment key={work._id}>
                <View style={{ width:'100%', flexDirection :'row'}}>
                    <View style={[styles.tbody, styles.tbody2]}>
                        <Text >{work.client.name}</Text>   
                    </View>
